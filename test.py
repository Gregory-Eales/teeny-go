...
tgn1.load_state_dict(torch.load("models/Model-R3-C32/Model-R3-C32-V2.pt"))
tgn2.load_state_dict(torch.load("models/Model-R5-C64/Model-R5-C64-Vtrained.pt"))
...
tester.play_through_games(tgn3, tgn2, num_games=100)
