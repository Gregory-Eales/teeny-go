...
value_net = ValueNetwork(alpha=0.000001, num_res=12, num_channel=256, in_chan=3)
...
value_net.optimize(x, y, x_t, y_t, batch_size=8,
 iterations=20, alpha=0.01, test_interval=10, save=True)
