...
def main():
    ...
    parser.add_option("--games", type="int", default=10, metavar="COUNT")
    parser.add_option("--verbose", type="choice", choices=('0','1','2'),
                      default=1, metavar="0|1|2")
    ...
    black = "C:/Users/Greg/Desktop/gnugo-3.8/gnugo --mode=gtp --level 1"
    white = "C:/Users/Greg/Desktop/Repositories/Teeny-Go/dist/random_agent"

    black_command = shlex.split(black)
    white_command = shlex.split(white)
